...
function getHtmlBody(firstName, type) {
  ...
  switch (type) {
    ...
    case 'multiple':
      mainContent = `<p>Thank you for requesting a bundle (Home & Auto) insurance quote with GJS Risk Solutions.</p>
      <p>We are shopping top carriers in Texas to find you the best bundled rates and coverage for both your home and auto policies. Gregory Smith will review your information and follow up with you shortly.</p>`;
      break;
